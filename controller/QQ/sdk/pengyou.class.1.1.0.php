...
class Pengyou
{
	...
	/**
	 * Pengyou OpenAPI 服务器的地址（域名或IP）
	 * 具体API地址请参考文档 http://wiki.opensns.qq.com/wiki/user/info
	 * 注意区分正式、测试环境
	 */
	private $serverName = '';
	...
	private function makeRequest($url, $params)
	{
		...
		$opts[CURLOPT_USERAGENT] = 'pengyou-php-1.1';
	...
	/**
	 * 根据要调用的方法返回 API URL
	 *Q点充值   本OpenAPI的正式IP为：119.147.74.44 ；测试IP为：119.147.75.204
	 * @param string $method API方法名
	 * @return string API URL
	 */
	private function getApiUrl($method)
	{
		if($method=="qz_buy_goods")
		{
			
			//return 'https://119.147.75.204/v2/r/qzone/' . $method;
			return 'https://119.147.74.44/v2/r/qzone/' . $method;
		}
